...
| dart-sass | 1.86.3-1 |
| direnv | 2.36.0-1 |
| discord_arch_electron | 1:0.0.97-1 |
| dkms | 3.2.1-1 |
...
| gst-plugin-va | 1.26.2-2 |
| gst-plugins-bad | 1.26.2-2 |
| gst-plugins-good | 1.26.2-2 |
| gst-plugins-ugly | 1.26.2-2 |
| gtklock | 4.0.0-1 |
...
| hyprlock | 0.8.2-1 |
| hyprls-git | 0.7.0-1 |
| hyprpicker-git | 0.4.5.r6.g68bc787-1 |
...
| lib32-gst-plugins-base | 1.26.2-1 |
| lib32-gst-plugins-base-libs | 1.26.2-1 |
| lib32-gst-plugins-good | 1.26.2-1 |
| lib32-gstreamer | 1.26.2-1 |
| lib32-libelf | 0.193-1 |
| lib32-mangohud | 0.8.1-1 |
| lib32-pipewire | 1:1.4.5-1 |
| libadwaita | 1:1.7.4-1 |
| libastal-4-git | r782.822c0d6-1 |
| libastal-apps-git | r782.822c0d6-1 |
| libastal-battery-git | r782.822c0d6-1 |
| libastal-bluetooth-git | r782.822c0d6-1 |
| libastal-hyprland-git | r782.822c0d6-1 |
| libastal-io-git | r782.822c0d6-1 |
| libastal-mpris-git | r782.822c0d6-1 |
| libastal-network-git | r782.822c0d6-1 |
| libastal-notifd-git | r782.822c0d6-1 |
| libastal-powerprofiles-git | r782.822c0d6-1 |
| libastal-river-git | r782.822c0d6-1 |
| libastal-tray-git | r782.822c0d6-1 |
| libastal-wireplumber-git | r782.822c0d6-1 |
...
| vlc-git | 4.0.0.r34009.g5503b39-1 |
| wbg | 1.2.0-1 |
| wf-recorder | 0.5.0-2 |
| wget | 1.25.0-2 |
