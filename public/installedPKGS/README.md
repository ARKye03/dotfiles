...
| dart-sass | 1.89.2-1 |
| direnv | 2.37.1-1 |
| discord_arch_electron | 1:0.0.102-1 |
| dkms | 3.2.1-1 |
...
| gsound | 1.0.3-3 |
| gst-libav | 1.26.4-1 |
| gst-plugin-gtk | 1.26.4-1 |
| gst-plugin-gtk4 | 0.14.0-1 |
| gst-plugin-pipewire | 1:1.4.6-1 |
| gst-plugin-va | 1.26.4-1 |
| gst-plugins-bad | 1.26.4-1 |
| gst-plugins-good | 1.26.4-1 |
| gst-plugins-ugly | 1.26.4-1 |
| gtklock | 4.0.0-1 |
...
| lib32-gst-plugins-base | 1.26.4-1 |
| lib32-gst-plugins-base-libs | 1.26.4-1 |
| lib32-gst-plugins-good | 1.26.4-1 |
| lib32-gstreamer | 1.26.4-1 |
| lib32-libelf | 0.193-1 |
| lib32-mangohud | 0.8.1-1 |
| lib32-pipewire | 1:1.4.6-1 |
| libadwaita | 1:1.7.5-1 |
| libastal-4-git | r823.2c5eb54-1 |
| libastal-apps-git | r823.2c5eb54-1 |
| libastal-battery-git | r823.2c5eb54-1 |
| libastal-bluetooth-git | r823.2c5eb54-1 |
| libastal-hyprland-git | r823.2c5eb54-1 |
| libastal-io-git | r823.2c5eb54-1 |
| libastal-mpris-git | r823.2c5eb54-1 |
| libastal-network-git | r823.2c5eb54-1 |
| libastal-notifd-git | r823.2c5eb54-1 |
| libastal-powerprofiles-git | r823.2c5eb54-1 |
| libastal-river-git | r823.2c5eb54-1 |
| libastal-tray-git | r823.2c5eb54-1 |
| libastal-wireplumber-git | r823.2c5eb54-1 |
| libgnome-keyring | 1:3.12.0+r14+g23438cc-1 |
| libgtop | 2.41.3-2 |
| libpulse | 17.0+r43+g3e2bb8a1e-1 |
| libreoffice-still | 24.8.7-4 |
| libva-nvidia-driver | 0.0.14-1 |
| linux | 6.15.7.arch1-1 |
| linux-firmware | 20250708-1 |
| linux-headers | 6.15.7.arch1-1 |
| loupe | 48.1-1 |
| lswt | 2.0.0-1 |
...
| visual-studio-code-bin | 1.102.1-1 |
| vlc-git | 4.0.0.r34284.gf4f3baf-1 |
| wbg | 1.3.0-1 |
| wf-recorder | 0.5.0-2 |
| wget | 1.25.0-2 |
