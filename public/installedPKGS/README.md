...
| dex | 0.10.1-1 |
| direnv | 2.37.1-1 |
| discord_arch_electron | 1:0.0.119-1 |
| dmidecode | 3.7-1 |
...
| gnome-network-displays | 0.98.0-1 |
| gnome-online-accounts | 3.56.2-1 |
| gnome-power-manager | 43.0-3 |
| gnome-system-monitor | 49.1-1 |
...
| gsound | 1.0.3-3 |
| gst-libav | 1.26.10-1 |
| gst-plugin-gtk | 1.26.10-1 |
| gst-plugin-gtk4 | 0.14.4-1 |
| gst-plugin-pipewire | 1:1.4.9-2 |
| gst-plugin-va | 1.26.10-1 |
| gst-plugins-bad | 1.26.10-1 |
| gst-plugins-good | 1.26.10-1 |
| gst-plugins-ugly | 1.26.10-1 |
| gtk4 | 1:4.20.3-1 |
...
| vlc | 3.0.21-32 |
| vlc-plugin-chromecast | 3.0.21-32 |
